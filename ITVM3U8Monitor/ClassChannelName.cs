...
//CDTV-2	123739
        ...
        public ClassChannelName()
        {
            ...
            chitem.Add(new ChannelItem { id = "8", name = "DOX-新艺", tvid = "134330" });
            ...
            chitem.Add(new ChannelItem { id = "14", name = "江西卫视", tvid = "112230" });
            ...
            chitem.Add(new ChannelItem { id = "18", name = "广东卫视", tvid = "112270" });
            chitem.Add(new ChannelItem { id = "19", name = "贵州卫视", tvid = "112210" });
            chitem.Add(new ChannelItem { id = "20", name = "四川卫视", tvid = "112320" });
            chitem.Add(new ChannelItem { id = "21", name = "劲爆体育", tvid = "145730" });
            chitem.Add(new ChannelItem { id = "22", name = "安徽卫视", tvid = "112240" });
            chitem.Add(new ChannelItem { id = "23", name = "CCTV-NEWS", tvid = "101520" });
            chitem.Add(new ChannelItem { id = "24", name = "金鹰卡通", tvid = "123320" });
    ...
    class ChannelPort
    {
        ...
        chitem.Add(new ChannelPortItem { ChannelId="213",ServiceId="112230_400k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-213.m3u8"});
        chitem.Add(new ChannelPortItem { ChannelId="113",ServiceId="112230_1000k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-113.m3u8"});
        ...
        chitem.Add(new ChannelPortItem { ChannelId="218",ServiceId="134330_400k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-218.m3u8"});
        chitem.Add(new ChannelPortItem { ChannelId="118",ServiceId="134330_1000k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-118.m3u8"});
        ...
        chitem.Add(new ChannelPortItem { ChannelId="443", ServiceId="112270_400k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-443.m3u8"});
        chitem.Add(new ChannelPortItem { ChannelId="8", ServiceId="112270_1000k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-8.m3u8"});
        chitem.Add(new ChannelPortItem { ChannelId="478", ServiceId="112210_400k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-478.m3u8"});
        chitem.Add(new ChannelPortItem { ChannelId="67", ServiceId="112210_1000k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-67.m3u8"});
        ...
        chitem.Add(new ChannelPortItem { ChannelId="476", ServiceId="145730_400k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-476.m3u8"});
        chitem.Add(new ChannelPortItem { ChannelId="69", ServiceId="145730_1000k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-69.m3u8"});
        ...
        chitem.Add(new ChannelPortItem { ChannelId="472", ServiceId="123320_400k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-472.m3u8"});
        chitem.Add(new ChannelPortItem { ChannelId="72", ServiceId="123320_1000k",URL="http://scgd-m3u8.joyseetv.com:8080/trans_m3u8/DWHLS-72.m3u8"});
